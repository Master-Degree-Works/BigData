...
import cat.eps.movieRecommender.outputFormat.JsonOutputFormat;
...
public class MovieRecommender extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		job1InputReader.setOutputFormatClass(JsonOutputFormat.class);
		job1InputReader.setOutputKeyClass(LongWritable.class);
		job1InputReader.setOutputValueClass(JsonWritable.class);
